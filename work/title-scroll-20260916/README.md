...
- `visual-report.json` and `visual-3d.png`: actual 3D scene loaded at 1743×939, both titles animated continuously, no JavaScript errors; the isolated probe paused rendered frames only for the screenshot.
